	...
	<section class="loginSection">
		<form action="">
			...
			<div class="loginForm">
				<!-- <h1>JOIN</h1> -->
				<div class="inputs">
					ID<input style="margin-bottom: 10px" type="text" /><label for=""
						class="repeatPwd">Password <a
						class="toUpdatePwd" href="updatePwd.do">비밀번호
							변경</a></label><input type="password" name="" id="password1" /><label for=""
						class="repeatPwd">Password <spqn
							class="confirmPwd"></spqn></label><input type="password" name=""
						id="password2" /> 이름 <input type="text" name="" id="" /> 닉네임 <input
						type="text" id="userNickname" /> 전화번호 <input type="text" name=""
